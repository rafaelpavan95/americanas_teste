...
def aplicacao_local(dados):
    ...
    input: 
        ...
        dados -> dataframe pandas contendo os dados em sua forma bruta.
        
    output:
        
        previsto -> vetor numpy contendo as previsões;
    ...
    previsto = rf_model.predict(dados)
